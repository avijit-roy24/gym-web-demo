...
export default function Timetable() {
  ...
  const handleRowHover = (className: string) => {
    if (hasShown.current) return; // don't show again
  ...
  return (
    <section id="timetable" className="py-24 bg-zinc-950 border-y border-zinc-900 relative overflow-hidden">
      {/* Background glow */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="text-primary tracking-widest text-sm font-bold uppercase">Schedule</span>
          <div className="flex justify-center mt-3">
            <div className="flex space-x-2">
              ...
              <FlipText
                ...
                duration={0.4}
                delayMultiple={0.06}
                className="text-4xl sm:text-6xl font-extrabold tracking-tighter text-primary"
              />
            </div>
          </div>
          <p className="mt-4 max-w-2xl text-lg text-zinc-400 mx-auto">
            Open every day. Hover over any class to instantly book your <span className="text-primary font-semibold">free trial</span>!
          </p>
        </motion.div>
