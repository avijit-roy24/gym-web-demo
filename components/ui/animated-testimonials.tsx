...
export const AnimatedTestimonials = ({
  ...
  useEffect(() => {
    // Generate stable random rotations on mount to prevent hydration mismatch
    setRandomRotations(
      ...
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
        ...
        <div className="flex justify-between flex-col py-4">
          ...
          <div className="flex gap-4 pt-12 md:pt-0">
            <button
              onClick={handlePrev}
              className="h-7 w-7 rounded-full bg-zinc-800 flex items-center justify-center group/button hover:bg-zinc-700 transition"
            >
