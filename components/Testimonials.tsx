...
export default function Testimonials() {
  const reviews = [
    ...
    },
    {
      name: "Nikita Kaushik",
      date: "5 years ago",
      text: "This is a fantastic gym!! With latest equipments and a clean, hygienic environment. It allows you to not only use equipments but offers programs like Yoga, spin sessions, circuit training.",
      rating: 5,
    },
    {
      name: "Raj World",
      date: "2 months ago",
      text: "Great gym with friendly trainers and a motivating environment. Clean space, good equipment, and proper guidance. Totally worth it!",
      rating: 5,
    },
    {
    ...
    },
    {
      name: "Aastha Arun",
      date: "A year ago",
      text: "Amazing experience in Health Freaks, advanced gym equipments, online workout options. My trainer Sonu Sir is an experienced, hard working professional.",
      rating: 5,
    },
    {
      name: "Aryan Singh",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <div className="mt-4 flex flex-col items-center gap-1 justify-center">
            ...
            <p className="text-xl text-zinc-400">4.4 / 5.0 (427+ Reviews)</p>
          </div>
        </div>
        ...
        <div className="columns-1 md:columns-2 lg:columns-3 gap-8 space-y-8">
          {reviews.map((review, i) => (
            <div
              key={i}
              className="break-inside-avoid bg-zinc-900 rounded-2xl p-6 border border-zinc-800 hover:border-zinc-700 transition-colors shadow-lg"
            >
              ...
              <p className="text-zinc-300 italic text-base leading-relaxed mb-6">
                "{review.text}"
              </p>
              <div className="flex items-center justify-between border-t border-zinc-800 pt-4">
                <div>
                  <h4 className="font-bold text-white tracking-wide uppercase">{review.name}</h4>
