  ...
  return (
    <div className="relative overflow-hidden min-h-[90vh] flex items-center justify-center bg-zinc-950">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-0 left-[-20%] w-[500px] h-[500px] bg-primary/20 blur-[120px] rounded-full pointer-events-none" />
      </div>
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold tracking-tighter text-white leading-[1.1]">
              <div className="flex gap-3 mb-2">
                <FlipText
                  ...
                  duration={0.4}
                  delayMultiple={0.06}
                  className="text-5xl md:text-7xl font-extrabold -tracking-widest text-white"
                />
                <FlipText
                  word="YOUR"
                  duration={0.4}
              ...
              <div className="mt-4 -ml-4">
                <SamsungHelloEnglishEffect speed={0.2} />
              </div>
            </h1>

            <p className="text-lg md:text-xl text-zinc-400 font-light leading-relaxed max-w-xl">
              Equipped with world-class machineries, expert personal trainers, and high-energy group classes. Get ready to transform your goals into reality.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Button size="lg" className="h-14 px-8 text-base font-bold tracking-wide uppercase transition-transform hover:scale-105">
                Join Now <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
              <Button size="lg" variant="outline" className="h-14 px-8 text-base font-bold tracking-wide uppercase border-zinc-700 bg-transparent hover:bg-zinc-800 group">
                <Play className="mr-2 h-4 w-4 text-primary group-hover:text-primary-foreground transition-colors" /> Free Trial
              </Button>
            </div>

            <div className="flex items-center gap-6 pt-8 border-t border-zinc-800">
              <div className="flex flex-col">
                <span className="text-3xl font-bold text-white">4.4<span className="text-primary text-xl">★</span></span>
                <span className="text-zinc-500 text-sm uppercase tracking-wide">400+ Reviews</span>
              </div>
              <div className="w-px h-12 bg-zinc-800"></div>
              <div className="flex flex-col">
                <span className="text-3xl font-bold text-white">15+</span>
                <span className="text-zinc-500 text-sm uppercase tracking-wide">Expert Trainers</span>
              </div>
            </div>
          </motion.div>
        </div>
