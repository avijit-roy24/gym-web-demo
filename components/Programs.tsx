...
const features = [
  ...
  },
  {
    ...
    description:
      "Get a customized regimen designed for your unique goals, overseen by elite certified trainers.",
    icon: ShieldCheck,
...
export default function Programs() {
  return (
    <div id="programs" className="py-24 bg-zinc-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <WordPullUp
            words="OUR PROGRAMS"
            className="text-4xl font-extrabold tracking-tighter text-primary sm:text-5xl uppercase mb-2"
          />
        </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="h-48 overflow-hidden relative">
                ...
                />
                <feature.icon className="absolute bottom-4 left-4 h-8 w-8 text-primary z-20" aria-hidden="true" />
              </div>
              <div className="p-6">
